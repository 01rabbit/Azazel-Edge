...
def build_demo_overlay(result: Dict[str, Any]) -> Dict[str, Any]:
    ...
    return {
        ...
        "release_condition": str(arbiter.get("release_condition") or explanation.get("release_condition") or ""),
        ...
        "trace_id": str(explanation.get("trace_id") or execution.get("trace_id") or ""),
        "policy_profile": str(explanation.get("policy_profile") or ""),
        "config_hash": str(explanation.get("config_hash") or ""),
        "audit_path": str(execution.get("audit_path") or ""),
        "explanations_path": str(execution.get("explanations_path") or ""),
