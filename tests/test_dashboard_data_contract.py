...
class DashboardDataContractTests(unittest.TestCase):
    ...
    def test_dashboard_index_renders_new_sections(self) -> None:
        ...
        self.assertIn('id="sectionNav"', text)
        self.assertIn('id="sectionNavFleet"', text)
        self.assertIn('id="freshnessChip"', text)
        self.assertIn('id="refreshNowBtn"', text)
        self.assertIn('id="pollPauseBtn"', text)
        self.assertIn('id="evidenceFilterInput"', text)
        self.assertIn('id="backToTopBtn"', text)
        self.assertIn('id="workspaceAllBtn"', text)
        self.assertIn('id="workspaceNocBtn"', text)
        self.assertIn('id="workspaceSocBtn"', text)
        self.assertIn('id="workspaceSimpleBtn"', text)
        self.assertIn('id="simpleViewPanel"', text)
