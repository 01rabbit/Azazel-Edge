...
class DashboardDataContractTests(unittest.TestCase):
    ...
    def test_dashboard_index_renders_new_sections(self) -> None:
        ...
        self.assertIn('id="assistantOpsCommFrame"', text)
        self.assertIn('/ops-comm?embed=1', text)
        ...
        self.assertIn("M.I.O. Ops Communication", text)
        self.assertIn('id="assistantOpsCommFrame"', text)
        self.assertIn('id="assistantOpsCommLink"', text)
        self.assertIn('id="assistantMattermostLink"', text)
        self.assertIn("/ops-comm?embed=1", text)
