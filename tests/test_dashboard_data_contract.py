...
class DashboardDataContractTests(unittest.TestCase):
    ...
    def test_dashboard_index_renders_new_sections(self) -> None:
        ...
        self.assertIn('href="#commandStripSection"', text)
        self.assertIn('href="#resourceGuardSection"', text)
        self.assertIn('href="#missionRowSection"', text)
        self.assertIn('href="#situationBoardSection"', text)
        self.assertIn('href="#splitBoardSection"', text)
        self.assertIn('href="#clientIdentitySection"', text)
        self.assertIn('href="#actionBoardSection"', text)
        self.assertIn('href="#evidenceBoardSection"', text)
        self.assertIn('href="#topoLiteInlinePanel"', text)
