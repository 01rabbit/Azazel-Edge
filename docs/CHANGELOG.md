...
### Added
- Documentation updates for the Azazel series naming change (2026-07-10): Azazel-CTI → Azazel-Grimoire (AZ-04) and Azazel-Common → Azazel-Covenant (AZ-05). Updated the README series table, `docs/INDEX.md`, and added a naming-update status note to `docs/AZAZEL_COMMON_EDGE_ADAPTER_PLAN.md` (file not renamed; body text and `azazel_common` references pre-`v0.3.0` are left as originally written).
