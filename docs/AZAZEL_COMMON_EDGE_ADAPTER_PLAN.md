...
> **2026-07-10 naming update:** Azazel-Common was renamed **Azazel-Fabric**
> (AZ-05) on 2026-07-10. From `v0.3.0` the import namespace is
> `azazel_fabric`; the `v0.1.0`/`v0.2.0` tags referenced below keep the
...
> new `azazel_fabric` namespace instead. The file itself is not renamed —
...
Azazel-CTI (now Azazel-Knowledge) is a next-fiscal-year-onward (FY2027+) plan. The material below
