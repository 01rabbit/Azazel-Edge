...
## Candidate CFP Profiles

| Concept | Status | Notes |
|---|---|---|
| Auditable Edge SOC/NOC | Candidate CFP draft only | Submission-preparation material only. Not accepted, not scheduled. See the [CFP draft](../cfp/blackhat-europe-arsenal-auditable-edge-socnoc.md). |
